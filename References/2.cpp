// Comparing Pointer and References
...
/*So we are still referencing the same memory with our reference.

And what we just did here was just grab the value in some other double value and assign that in here.

But the reference is referencing the same memory location it's been referencing.

So in C plus plus you don't have a way you can go through to make a reference reference something else.*/
