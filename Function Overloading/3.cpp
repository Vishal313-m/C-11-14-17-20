oVERLOADING IN REFERENCE  pARAMETER  
...
int main(){
    ...
    char a{6};
    char b{9};
    // Call the int function by modifying the argument types
   //  int result = max(static_cast<int>(a), static_cast<int>(b)); POSSIBLE SOLTUION 
