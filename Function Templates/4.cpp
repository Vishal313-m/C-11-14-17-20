// Template Specialization -Template specialization allows optimizing implementations for specific types



/*SYNTAX 
template <>
return_type function_name<specialized_type>(parameters) {
